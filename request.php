...
&&isset($_POST['purpose']))
{
   ...
   {
     $query="insert into `request` values('','".mysqli_real_escape_string($name)."','".mysqli_real_escape_string($bloodgroup)."','".mysqli_real_escape_string($age)."','".mysqli_real_escape_string($day)."','".mysqli_real_escape_string($month)."','".mysqli_real_escape_string($year)."','".mysqli_real_escape_string($units)."','".mysqli_real_escape_string($mob_no)."','".mysqli_real_escape_string($location)."','".mysqli_real_escape_string($hospital)."','".mysqli_real_escape_string($address)."','".mysqli_real_escape_string($purpose)."','')";
